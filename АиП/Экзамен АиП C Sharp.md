...
```
Если объект реализует несколько интерфейсов с одинаковыми методами, можно реализовать оба интерфейса и уточнять, реализацию какого из них необходимо вызвать:
```cs
namespace ns
{
    class Program
